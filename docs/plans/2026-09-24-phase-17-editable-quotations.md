...
| `data/migrations/202609241200_quotation_versions.ts` (new) | Versions table, RLS, backfill |
...
**Files:**
- Create: `data/migrations/202609241200_quotation_versions.ts`
- Modify (generated): `src/lib/db/schema.ts`

- [ ] **Step 1: Write the migration**

```ts
// data/migrations/202609241200_quotation_versions.ts
...
npm run db:codegen
```
Expected: migrate reports `202609241200_quotation_versions` applied; `src/lib/db/schema.ts` gains `OrderQuotationVersions` and `DB["order_quotation_versions"]`.
...
```bash
git add data/migrations/202609241200_quotation_versions.ts src/lib/db/schema.ts
